...
def main():
    ...
    parser.add_argument('--checkpoints_root', default='/disk2/EGCTNet_jkw/checkpoints', type=str)
    parser.add_argument('--vis_root', default='/disk2/EGCTNet_jkw/vis', type=str)
    ...
    parser.add_argument('--split', default="text", type=str)
    ...
    parser.add_argument('--checkpoint_name', default='/disk2/EGCTNet_jkw/checkpoints/chongqing_EGCTNet_eas_bs16_0.0001/best_ckpt.pt', type=str)
